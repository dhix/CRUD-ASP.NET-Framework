...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <asp:Label ID="lbl_codigo" runat="server" Text="Código" CssClass="badge" Font-Bold="True" Font-Size="Medium"></asp:Label>
        <asp:TextBox ID="txt_codigo" runat="server" CssClass="form-control" placeholder="E001" ForeColor="Aqua"></asp:TextBox>
        ...
        <asp:Label ID="lbl_direccion" runat="server" Text="Dirección" CssClass="badge" Font-Bold="True" Font-Size="Medium"></asp:Label>
        <asp:TextBox ID="txt_direccion" runat="server" CssClass="form-control" placeholder="Calle/Avenida/Sector #Casa"></asp:TextBox>

        <asp:Label ID="lbl_telefono" runat="server" Text="Teléfono" CssClass="badge" Font-Bold="True" Font-Size="Medium"></asp:Label>
        <asp:TextBox ID="txt_telefono" runat="server" CssClass="form-control" placeholder="12345678"></asp:TextBox>

        <asp:Label ID="lbl_fn" runat="server" Text="Fecha nac" CssClass="badge" Font-Bold="True" Font-Size="Medium"></asp:Label>
